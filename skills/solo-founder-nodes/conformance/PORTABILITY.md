...
|---|---|---|
| **Substrate is identical everywhere** | `templates/` is plain Node/Python; `npm i && npm run smoke` currently reports **151 passed, 0 failed** with zero agent involvement | proven (reproducible by anyone) |
...
| **Codex (OpenAI)** | A/B - Codex Skills / `AGENTS.md`, else C | local probe PASS, receipt `d06d5d02e52139b0`, current substrate smoke 151/151 |
