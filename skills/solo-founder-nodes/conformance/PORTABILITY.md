...
|---|---|---|
| **Substrate is identical everywhere** | `templates/` is plain Node/Python; `npm i && npm run smoke` currently reports **156 passed, 0 failed** with zero agent involvement | proven (reproducible by anyone) |
...
|---|---|---|
| **Claude Code** | A - `.claude/skills/<name>/SKILL.md` auto-discovered | prior probe PASS, receipt `468f7aef456c64e8`; rerun for current 151-test substrate |
| **Codex (OpenAI)** | A/B - Codex Skills / `AGENTS.md`, else C | local probe PASS, receipt `1eafbd8669d1a404`, current substrate smoke 156/156 |
| **Trae IDE** | A/C - `SKILL.md` per the standard, else bootstrap | run the probe |
| **OpenClaw** | A/C - `SKILL.md` per the cross-vendor standard | prior local probe PASS via OpenRouter/DeepSeek V4 Flash, receipt `311d4ca418744ba5`, older smoke 74/74; rerun for current 151-test substrate; see [`../../../docs/AGENT_PORTABILITY_PROOF.md`](../../../docs/AGENT_PORTABILITY_PROOF.md) |
| **Hermes** | A/C - `SKILL.md` per the standard | prior local probe PASS via OpenRouter/Qwen3 Coder Next, receipt `311d4ca418744ba5`, older smoke 74/74; rerun for current 151-test substrate; see [`../../../docs/AGENT_PORTABILITY_PROOF.md`](../../../docs/AGENT_PORTABILITY_PROOF.md) |
